...
var pyniteEditorMoreButton = document.querySelector("#pyniteEditorMoreButton");
var pyniteMoreButton = document.querySelector("#pyniteMoreButton");
...
pyniteEditorMoreButton.addEventListener("click", function(){
    window.location.href = "pynite_editor_info.html";
});

pyniteMoreButton.addEventListener("click", function(){
    window.location.href = "pynite_info.html";
});